...
update-deps:
	...
	pip-compile --upgrade --resolver=backtracking --build-isolation --generate-hashes --output-file requirements/main.in requirements/main.in
	pip-compile --upgrade --resolver=backtracking --build-isolation --generate-hashes --output-file requirements/dev.in requirements/dev.in
